const purchasedamageInvoice = Vue.component('purchasedamage-invoice', {
    template: `
        <div>
            <div class="row">
                <div class="col-xs-12">
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>Supplier Id:</strong> {{ damage.Supplier_Code }}<br>
                        <strong>Supplier Name:</strong> {{ damage.Supplier_Name }}<br>
                        <strong>Supplier Address:</strong> {{ damage.Supplier_Address }}<br>
                        <strong>Supplier Mobile:</strong> {{ damage.Supplier_Mobile }}
                    </div>
                    <div class="col-xs-5 text-right">
                        <strong>Damage by:</strong> {{ damage.AddBy }}<br>
                        <strong>Invoice No.:</strong> {{ damage.Damage_invoiceNo }}<br>
                        <strong>Damage Date:</strong> {{ damage.Damage_Date }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.Damage_Price }}</td>
                                    <td align="right">{{ product.Damage_TotalAmount }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(damage.Damage_Total) }}<br><br>
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ damage.note }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods:{
        getDamage(){
            axios.post('/get_supplierwise_damage', {damageId: this.damage_id}).then(res=>{
                this.damage = res.data.damages[0];
                ...
                <body>
                    ...
                    <div class="container" style="position:fixed;bottom:15px;width:100%;">
                        ...
                        <div class="row" style="font-size:12px;">
                            <div class="col-xs-6">
                                Print Date: ${moment().format('DD-MM-YYYY h:mm a')}, Printed by: ${this.damage.AddBy}
                            </div>
                            <div class="col-xs-6 text-right">
