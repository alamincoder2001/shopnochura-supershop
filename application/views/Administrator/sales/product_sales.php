					...
					<div class="row">
						<div class="col-md-5 col-xs-12">
							<div class="form-group clearfix" style="margin-bottom: 8px;">
								...
								<div class="col-xs-8">
									<input type="radio" name="salesType" value="retail" id="retail" v-model="sales.salesType" v-on:change="onSalesTypeChange"> <label style="margin: 0;" for="retail">Retail</label> &nbsp;
									<input type="radio" name="salesType" value="wholesale" id="wholesale" v-model="sales.salesType" v-on:change="onSalesTypeChange"> <label style="margin: 0;" for="wholesale"> Wholesale </label>
								</div>
							</div>
							<div class="form-group">
	...
	new Vue({
		...
		methods: {
			...
			addToCart() {
				...
				if ((product.salesRate == 0 || product.salesRate == '') && product.is_free == 'false') {
