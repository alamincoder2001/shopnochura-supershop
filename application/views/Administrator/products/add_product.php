			...
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-2 no-padding-right">
						<input type="number" min="0" class="form-control" v-model="product.per_unit_convert">
					</div>
					<label class="control-label col-md-2 no-padding-right">Conv. Unit:</label>
					<div class="col-md-3">
						<input type="text" class="form-control" v-model="product.converted_name" placeholder="Converted Name">
					</div>
				</div>
				<div class="form-group clearfix">
